...
U 1 1 5A7F7482
P 8800 3400
F 0 "#PWR041" H 8800 3150 50  0001 C CNN
...
U 1 1 5A7F7645
P 7850 3250
F 0 "#PWR042" H 7850 3100 50  0001 C CNN
...
U 1 1 5A7F7940
P 8400 7950
F 0 "#PWR043" H 8400 7700 50  0001 C CNN
...
F 2 "Capacitors_SMD:C_1206" H 800 6200 50  0001 C CNN
...
F 2 "Capacitors_SMD:C_1206" H 1200 6200 50  0001 C CNN
...
U 1 1 5A7F8695
P 800 6400
F 0 "#PWR044" H 800 6150 50  0001 C CNN
...
U 1 1 5A7F869B
P 1200 6400
F 0 "#PWR045" H 1200 6150 50  0001 C CNN
...
F 2 "Capacitors_SMD:C_1206" H 1500 8100 50  0001 C CNN
...
F 2 "Capacitors_SMD:C_1206" H 1900 8100 50  0001 C CNN
...
U 1 1 5A7F8A34
P 1500 8300
F 0 "#PWR046" H 1500 8050 50  0001 C CNN
...
U 1 1 5A7F8A3A
P 1900 8300
F 0 "#PWR047" H 1900 8050 50  0001 C CNN
...
F 2 "Capacitors_SMD:C_1206" H 1900 3800 50  0001 C CNN
...
U 1 1 5A7F96B5
P 1900 4050
F 0 "#PWR048" H 1900 3800 50  0001 C CNN
...
U 1 1 5A7FA9BE
P 1400 4200
F 0 "#PWR049" H 1400 3950 50  0001 C CNN
...
U 1 1 5A7FAB49
P 600 4050
F 0 "#PWR050" H 600 3900 50  0001 C CNN
F 1 "VCC" H 600 4200 50  0000 C CNN
...
U 1 1 5A7FC200
P 1650 10100
F 0 "#PWR051" H 1650 9850 50  0001 C CNN
...
F 2 "Pin_Headers:Pin_Header_Straight_1x06_Pitch2.54mm" H 1450 10100 50  0001 C CNN
...
F 2 "Pin_Headers:Pin_Header_Straight_1x03_Pitch2.54mm" H 3400 9950 50  0001 C CNN
...
U 1 1 5A7FF0DB
P 3950 9850
F 0 "#PWR052" H 3950 9600 50  0001 C CNN
...
F 2 "Capacitors_SMD:C_1206" H 7850 3450 50  0001 C CNN
...
U 1 1 5A806A82
P 7850 3550
F 0 "#PWR054" H 7850 3300 50  0001 C CNN
...
Text HLabel 2150 6750 0    60   Input ~ 0
Left
Text HLabel 2150 6550 0    60   Input ~ 0
Right
Text HLabel 15550 4950 2    60   Input ~ 0
Up
...
$EndComp
Wire Wire Line
	14550 6250 14750 6250
Text HLabel 14750 5250 2    60   Output ~ 0
PANASHUTTER
Text HLabel 14750 5350 2    60   Output ~ 0
PANAFOCUS
Wire Wire Line
